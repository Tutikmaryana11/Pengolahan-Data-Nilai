...
<html>
    ...
    <body class="body-login" background="../../file/img/gambar-belakang.jpg">
         
        <div class="row ">
            <div class="col-md-4 col-md-offset-4" style="margin-top:10%">
               <div class="login-panel panel panel-default">
                <p style="background-color: transparent" class="login-box-msg"><h3 align="center">LOGIN PAGE</h3> </p>
                    ...
                    <div class="panel-body tooltip-demo" >
                            <form action="../process/signin.php" method="post">
                                ...
                                <!-- <div class="row mar"> -->
                                    <!-- <div class="pull-left"> -->
                                        <!-- <img src="../file/img/logo.png" width="100"> -->
                                    <!-- </div> -->
                                    <div align="justify">
                                        <!-- <p></p> -->
                                        <!-- <h3>DAPODIKDAS V.2</h3> -->
