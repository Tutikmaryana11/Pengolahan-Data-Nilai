...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"><span class="fa fa-file"></span> Laporan Nilai </h1>
    </div>
    <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
    ...
    <div class="col-lg-12">
      <div>
        <ol class="breadcrumb">
          ...
          <li class="active">
            <i class="fa fa-file"></i> Laporan Nilai
          </li>
        </ol>
      </div>
        ...
        <div class="panel-body">    
          ...
          <script type="text/javascript">
            function cetak() {
              var kelas = $("#kelas").val();
              var mapel = $("#mapel").val();
              window.open('index.php?view=view_nilai_tugas&id_kelas='+kelas+'&id_mapel='+mapel);
            }
          </script>
