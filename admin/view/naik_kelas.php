...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"><span class="fa fa-file"></span> Naik Kelas </h1>
    </div>
    <!-- /.col-lg-12 -->
  </div>
  <!-- /.row -->
    ...
    <div class="col-lg-12">
      <div>
        <ol class="breadcrumb">
          ...
          <li class="active">
            <i class="fa fa-file"></i> Cari Data Siswa
          </li>
        </ol>
      </div>
        ...
        <div class="panel-body">    
          ...
          <div class="form-group">
            ...
            <form class="form-horizontal" id="form" role="form" method="get" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-sm-3">
                  <button type="button" class="btn btn-info" onclick="cetak()">Lihat data siswa</button>
          ...
          <script type="text/javascript">
            function cetak() {
              var kelas = $("#kelas").val();
              // var mapel = $("#mapel").val();
              window.open('index.php?view=siswa_naik&id_kelas='+kelas);
            }
          </script>
          ...
          <script type="text/javascript">
            function export_excel() {
              var kelas = $("#kelas").val();
              var mapel = $("#mapel").val();
              window.open('index.php?view=export_nilai&id_kelas='+kelas+'&id_mapel='+mapel);
            }
          </script>
