...
// Connection
$conn = mysqli_connect( "localhost", "root", "", "dapodikdas_v2" ) or die ( "Error !".mysqli_error( $conn ) );
...
*/
$get_data = mysqli_query( $conn, "SELECT RIGHT(id_berita,3) FROM berita ORDER BY RIGHT(id_berita,3) DESC" );
