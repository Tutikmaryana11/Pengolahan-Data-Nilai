...
// Connection
$conn = mysqli_connect( "localhost", "root", "", "sma_pamotan" ) or die ( "Error !".mysqli_error( $conn ) );
...
*/
$get_data = mysqli_query( $conn, "SELECT RIGHT(id_tugas,3) FROM tugas ORDER BY RIGHT(id_tugas,3) DESC" );
